...
import { Layers, Pencil, Info } from "lucide-react";
...
import { useTiers, useSaveTier } from "@/hooks/ekub";
...
function TiersInner() {
  ...
  return (
    <div className="space-y-6 p-4 lg:p-6">
      ...
      <Modal open={!!editing} onOpenChange={(o) => !o && setEditing(null)} title={t("editTier")} className="max-w-lg">
        {editing && (
